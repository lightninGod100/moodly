...
export const FE_VALIDATION_MESSAGES = {
  ...
  // Export individual categories for organized imports (optional)
  export const EMAIL_VALIDATION = {
    REQUIRED: FE_VALIDATION_MESSAGES.EMAIL_REQUIRED,
    INVALID: FE_VALIDATION_MESSAGES.EMAIL_INVALID,
  };
  
  export const PASSWORD_VALIDATION = {
    REQUIRED: FE_VALIDATION_MESSAGES.PASSWORD_REQUIRED,
    TOO_SHORT: FE_VALIDATION_MESSAGES.PASSWORD_TOO_SHORT,
  };
  
  export const USERNAME_VALIDATION = {
    REQUIRED: FE_VALIDATION_MESSAGES.USERNAME_REQUIRED,
    TOO_SHORT: FE_VALIDATION_MESSAGES.USERNAME_TOO_SHORT,
    TOO_LONG: FE_VALIDATION_MESSAGES.USERNAME_TOO_LONG,
    INVALID_FORMAT: FE_VALIDATION_MESSAGES.USERNAME_INVALID_FORMAT,
  };